...
public class Cita
{
    ...
    // Agregamos campos FechaRegistro y FechaActualizacion para control de auditoria
    // Campo autogenerado y único
    public DateTime FechaRegistro { get; set; } = DateTime.Now;

    // Campo que inicializará en null, cambiará con la fecha actual 
    // en la que se hizo la modificación de la cita
